...
setup(
    ...
    entry_points={
        'console_scripts': [
            'deepbiometall=deepbiometall.__main__:main',
        ],
    },
    ...
    keywords='deepbiometall',
    name='deepbiometall',
    packages=find_packages(include=['deepbiometall', 'deepbiometall.*']),
    test_suite='tests',
    tests_require=test_requirements,
    url='https://github.com/RaulFD-creator/deepbiometall',
    version='0.1.0',
    zip_safe=False,
)
